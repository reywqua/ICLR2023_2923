...
class OGB_Dataset(InMemoryDataset):
    ...
    def process(self):
        ...
        for t in dataset:
            if cnt%1000==0:
                print ('progress:',cnt)
            cnt +=1
            q, j = EdgeIndex_Processor(t.edge_index,t.num_nodes).run(random_walk_order=30)
...
if __name__=='__main__':
    ...
    name = 'ogbg-molpcba'   # see line 170
    name2 = 'molpcba'  # specify the name after transformation
    s = OGB_Dataset(root='data/ogb/'+name2)
